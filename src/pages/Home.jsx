        ...
        <div className="gap-2 relative flex flex-col items-center w-[100%] lg:whitespace-nowrap lg:w-[45rem] ">
          <div className="flex items-center w-[90%] justify-between lg:w-[95%] md:w-[95%]">
            ...
            <div className="flex items-center gap-2">
              {/* <Filter /> */}
              <select onChange={(e) => setSelectFilter(e.target.value)} className="p-2 font-semibold rounded-md">
          ...
          {!driwer && (
            <div className="absolute border-2 p-2 h-[95vh]  rounded-md bg-white lg:left-[-330px]  lg:h-[800px] md:h-[90vh] left-[-2px] top-[-8px] w-[98%] md:w-[70%] overflow-auto break-words">
              <div className="flex items-center font-bold gap-3 cursor-pointer" onClick={() => setDriwer(true)}>
                <GoChevronLeft />
                <span>Go back</span>
              </div>
              <div className="font-bold text-2xl mt-4">New Invoice</div>
              ...
              <div className="flex flex-col mt-4 gap-3">
                ...
                <select
                  ...
                  ref={selectRef}
                  id="paymentTerms"
                  className="appearance-none w-full py-2 px-4 border-[.2px] rounded-lg focus:outline-none border-gray-300 focus:outline-purple-400"
                >
